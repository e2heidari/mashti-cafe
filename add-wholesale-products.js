...
// Create client using environment variables that Sanity CLI provides
const client = createClient({
  projectId: 'eh05fgze',
  dataset: 'mashti-menu',
  apiVersion: '2024-01-01',
  useCdn: false,
  // The token will be automatically provided by Sanity CLI
})
...
async function addSampleWholesaleProducts() {
  try {
    ...
    console.log('💡 Make sure you are logged in to Sanity CLI')
  }
}
